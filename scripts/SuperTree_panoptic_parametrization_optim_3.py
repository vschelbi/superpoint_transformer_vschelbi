...
if __name__ == '__main__':
    ...
    areas = ['NIBIO', 'RMIT'] # Each area must have a corresponding config file in experiment/panoptic.
    i_clouds_train_forinstance = [1, 13] #, [0, 1, 13, 14, 16]     # mapping of train files to areas for grid search (hacky)
