...
if __name__ == '__main__':
    ...
    areas = ['CULS', 'TUWIEN'] # Each area must have a corresponding config file in experiment/panoptic.
    i_clouds_train_forinstance = [0, 16] #, [0, 1, 13, 14, 16]     # mapping of train files to areas for grid search (hacky)
