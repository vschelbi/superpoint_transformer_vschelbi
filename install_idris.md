...
# Commande principale
HYDRA_FULL_ERROR=1 WANDB_MODE=dryrun python src/train.py trainer=gpu logger=wandb_s3dis datamodule=s3dis model=spt trainer.max_epochs=10 test=True +logger.wandb.name="spt jz"
```