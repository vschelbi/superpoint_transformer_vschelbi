...
class SCION(FORinstance):
    """SCION dataset, extracted from the FOR-Instance dataset.
    ...
    def all_base_cloud_ids(self):
        ...
        """
        return {
            split: [x for x in plots if x.startswith('SCION')]
...
class MiniSCION(SCION):
    """A mini version of SCION with only a few plots for experimentation.
    """
    _NUM_MINI = 2
