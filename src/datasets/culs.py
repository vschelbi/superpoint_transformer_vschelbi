...
class CULS(FORinstance):
    """CULS dataset, extracted from the FOR-Instance dataset.
    ...
    def all_base_cloud_ids(self):
        ...
        """
        return {
            split: [x for x in plots if x.startswith('CULS')]
...
class MiniCULS(CULS):
    """A mini version of CULS with only a few plots for experimentation.
    """
    _NUM_MINI = 2
