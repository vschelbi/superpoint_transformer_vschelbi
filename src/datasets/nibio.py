...
class NIBIO(FORinstance):
    """NIBIO dataset, extracted from the FOR-Instance dataset.
    ...
    def all_base_cloud_ids(self):
        ...
        """
        return {
            split: [x for x in plots if x.startswith('NIBIO')]
...
class MiniNIBIO(NIBIO):
    """A mini version of NIBIO with only a few plots for experimentation.
    """
    _NUM_MINI = 2
