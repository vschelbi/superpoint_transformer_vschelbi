...
class TUWIEN(FORinstance):
    """TUWIEN dataset, extracted from the FOR-Instance dataset.
    ...
    def all_base_cloud_ids(self):
        ...
        """
        return {
            split: [x for x in plots if x.startswith('TUWIEN')]
...
class MiniTUWIEN(TUWIEN):
    """A mini version of TUWIEN with only a few plots for experimentation.
    """
    _NUM_MINI = 2
