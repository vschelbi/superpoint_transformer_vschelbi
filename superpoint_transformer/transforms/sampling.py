...
def sample_clusters(
    ...
    print('\nxxxxxxxxxxx  Sample clusters  xxxxxxxxxxxxx')
    ...
    print(f'    sub_size sum equals num_points: {sub_size.sum() == nag[low].num_nodes}')
    ...
    # Sort by super_index. Combined with the previous shuffling, this
